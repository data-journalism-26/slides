...
.pull-right[
## Classic question order experiment ([Schuman, Kalton and Ludwig 1983](https://www.jstor.org/stable/2748710))
...
<div align="center">
<br>
<img src="pics/pew-survey-methods.png" style="width:85%; height:auto;">
</div>
]
...
**CATI** (Computer-Assisted Telephone Interview): random-digit dialing or registry-based. Still used by major pollsters (Infratest dimap, Forsa). Declining response rates are a serious problem — down to ~5–10% in many countries.
...
2. For each new survey, a **sample is drawn from the panel** — either randomly or quota-based (e.g., targets for age × gender × region).
...
# Representativity everywhere

Question: How would you define "representative" in the context of surveys? What does it mean for a sample to be representative of a population?

<div align="center">
<img src="pics/samples.png" height=230>
</div>
...
👉 The R workshop script `code/surveys/working-with-surveys.qmd` walks through sampling simulation, weighting, and uncertainty visualization.
]
...
.pull-right[
<div align="center">
<img src="pics/dashboard-experiment-1.png" style="width:85%; height:auto;">
</div>
]
